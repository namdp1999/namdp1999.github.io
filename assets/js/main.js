! function(e) {
  ...
  }, i.p = "http://jd-dev-info.online/", i(i.s = 0)
}([function(e, t, i) {
  i(1), e.exports = i(2)
}, function(e, t) {
  function i(e, t) {
  ...
  function a(e, t, i) {
    ...
    $(document).ready(function(e) {
      ...
      function n(t, i) {
        var n = e(t).find(".accordion"),
          a = n.find(".accordion-header"),
          o = n.find(".accordion-body");
        e(t).find(".active-accordion").find(".accordion-body").slideDown(i), a.on("click", function() {
          var t = e(this).parent().find(".accordion-body"),
            a = e(this).parent();
      ...
      var l = {
        ...
        d = l.doc.querySelector(":root"),
        u = e(".hero-header"),
        p = e("#main-wrapper"),
        f = e(".loader"),
        v = "#E96060",
        g = e(".counters-wrapper"),
        m = e(".tabs-wrapper"),
        y = e(".accordion-wrapper"),
        b = e(".flip-section"),
        _ = e(".parallax-window"),
        x = e(".image-popup"),
        k = e(".video-popup"),
        ...
        C = e(".toggle-map"),
        T = !0,
        E = e(".progress-bar-line").length,
        P = e("#ajax-contact"),
        S = e(".hover3d-wrapper"),
        H = e(".grid"),
        F = e(".popup-gallery"),
        I = e(".button-group-default"),
        z = u.data("section-type"),
        L = e(".gradient-background"),
        R = e(".navigation-mobile");
          ...
          return a(t, [{
            ...
            value: function(t) {
              ...
              setInterval(function() {
                if (void 0 !== e) {
                  ...
                  t.css({
                    background: "-webkit-gradient(linear, left top, right top, from(" + d + "), to(" + u + "))"
                  }).css({
                    background: "-moz-linear-gradient(left, " + d + " 0%, " + u + " 100%)"
                  }), (n += o) >= 1 && (n %= 1, a[0] = a[1], a[2] = a[3], a[1] = (a[1] + Math.floor(1 + Math.random() * (i.length - 1))) % i.length, a[3] = (a[3] + Math.floor(1 + Math.random() * (i.length - 1))) % i.length)
                }
              }, 10)
            }
          }, {
            ...
            value: function() {
              var e, t, i, n, a, o = 100,
                ...
                h = 85,
                d = -342,
                u = l.win.innerWidth / 2,
                p = l.win.innerHeight / 2,
                f = this.canvas;
              ...
              function w(e) {
                ...
                for (var c = 2 * Math.PI, h = new THREE.SpriteCanvasMaterial({
                  ...
                  for (var p = 0; p < s; p++)(a = n[d++] = new THREE.Particle(h)).position.x = u * o - r * o / 2, a.position.z = p * o - s * o / 2, t.add(a);
              ...
              function o() {
                ...
                ! function() {
                  ...
                  for (var o = 0, l = 0; l < r; l++)
                    for (var u = 0; u < s; u++)(a = n[o++]).position.y = 50 * Math.sin(.3 * (l + c)) + 50 * Math.sin(.5 * (u + c)), a.scale.x = a.scale.y = 2 * (Math.sin(.3 * (l + c)) + 1) + 2 * (Math.sin(.5 * (u + c)) + 1);
                  i.render(t, e), c += .1
                }()
              }()
            }
          }, {
            key: "_particles_3d_header",
            value: function() {
              this._bg_gradient(L);
              var e, t, i, n = 0,
                a = 0,
                o = l.win.innerWidth / 2,
                r = l.win.innerHeight / 2,
                s = this.canvas,
                c = this.canvas_width,
              ...
              function f(e) {
                ...
                var n;
                (e = new THREE.PerspectiveCamera(75, l.win.innerWidth / l.win.innerHeight, 1, 1e4)).position.z = 100, t = new THREE.Scene, (i = new THREE.CanvasRenderer({
                  alpha: !0
                })).setPixelRatio(l.win.devicePixelRatio), i.setClearColor(0, 0), i.setSize(c, h), s.appendChild(i.domElement);
                ...
                var g = new THREE.Line(r, new THREE.LineBasicMaterial({
                  color: 15658734,
                  opacity: .2
                }));
            ...
            key: "_particles_snow_header",
            value: function() {
              var e, t = !0,
                i = this.canvas,
                n = this.canvas_width,
                a = this.canvas_height,
                o = this.canvas_header,
              ...
              function c() {
                n = l.win.innerWidth, a = l.win.innerHeight, o.css({
                  height: a + "px"
              ...
              function h() {
                if (t)
                  for (var i in r.clearRect(0, 0, n, a), e) e[i].draw();
            ...
            value: function() {
              ...
              var p = function() {
                ...
                m = function(t) {
                  var i = t - c;
                  if (c = t, !n.out)
                    for (r += i < 100 ? i : 100; r > 0; r -= s) l = l ? 0 : 1, o.push({
                      x: n.x,
                      y: n.y,
            ...
            value: function() {
              particlesJS(this.particles_wrapper, {
                particles: {
                  ...
                  color: {
                    value: ["#e30c0c", "#E96060", "#c73ede", "#996ce9", "#5f75ed", "#2196f3", "#df4b1d", "#ff9800", "#ffc107", "#e4c239"]
                  },
                  shape: {
                    type: "circle",
                    stroke: {
            ...
            key: "_particles_connect_header",
            value: function() {
              var e, t = !0,
                i = this.canvas_width,
                n = this.canvas_height,
                a = {
                  x: i / 2,
                  y: n / 2
                },
              ...
              function d() {
                if (t)
                  for (var o in r.clearRect(0, 0, i, n), e) Math.abs(v(a, e[o])) < 4e3 ? (e[o].active = .3, e[o].circle.active = .6) : Math.abs(v(a, e[o])) < 2e4 ? (e[o].active = .1, e[o].circle.active = .3) : Math.abs(v(a, e[o])) < 4e4 ? (e[o].active = .02, e[o].circle.active = .1) : (e[o].active = 0, e[o].circle.active = 0), p(e[o]), e[o].circle.draw();
              ...
              function p(e) {
                if (e.active)
                  for (var t in e.closest) r.beginPath(), r.moveTo(e.x, e.y), r.lineTo(e.closest[t].x, e.closest[t].y), r.strokeStyle = "rgba(156,217,249," + e.active + ")", r.stroke()
              }
              ...
              o.width = i, o.height = n,
                function() {
                  e = [];
                  for (var t = 0; t < i; t += i / 20)
                    for (var a = 0; a < n; a += n / 20) {
                      var o = t + Math.random() * i / 20,
                        r = a + Math.random() * n / 20,
                        s = {
                          x: o,
                          originX: o,
                          y: r,
            ...
            value: function() {
              ...
              r.setAttribute("width", c), r.setAttribute("height", h),
                function() {
            ...
            key: "_particles_confetti_header",
            value: function() {
              var e = [
                  [85, 71, 106],
                  [174, 61, 99],
            ...
            key: "_youtube_header",
            value: function() {
              e(this.youtube_wrapper).YTPlayer({
                fitToBackground: !1,
                videoId: "iGpuQ0ioPrM"
              })
            }
          }, {
            key: "_swiper_default_header",
            value: function() {
      ...
      e(l.body).imagesLoaded({
        ...
        if (y.length)
          for (var a = 0; a < y.length; a++) n(y[a], "fast");
        if (g.length)
        ...
        e(".progress-bar-line").waypoint(function() {
            ...
            offset: "100%"
          }), d.style.setProperty("--primary-color", v),
          function(e, t, i) {
          ...
          }), c.w >= 992 && S.length && e(S).hover3d({
            selector: ".hover3d-child"
          }), e(P).submit(function(t) {
            t.preventDefault();
