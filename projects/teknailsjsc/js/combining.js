...
if ("undefined" == typeof jQuery) throw new Error("Bootstrap's JavaScript requires jQuery"); + function(a) {
  ...
  if (!a.fn.tooltip) throw new Error("error-404.html");
        ...
        function() {
          ...
          jQuery(document).on("change", ".btn-file :file", function() {
            var e = jQuery(this),
              ...
              i = e.val().replace(/\\/g, "https://butterfly.dexignzone.com/").replace(/.*\//, "");
  ...
  a && Object.deepExtend(i, a), i.tmp.obj = {
    ...
    if (i.tmp.img_error = void 0, "" != i.particles.shape.image.src)
      if ("svg" == e) {
        ...
        a.open("error-404.html", i.particles.shape.image.src), a.onreadystatechange = function(e) {
    ...
    else console.log("error-404.html"), i.tmp.img_error = !0
...
Object.deepExtend = function(e, a) {
  ...
  i.open("error-404.html", a), i.onreadystatechange = function(a) {
    if (4 == i.readyState)
      if (200 == i.status) {
